...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section
        data-aos="fade-up"
        className="relative py-20 px-8 text-center bg-eco-white text-eco-green-light overflow-hidden"
      >
      ...
      <section
        data-aos="fade-up"
        className="py-20 px-8 bg-eco-green-light text-eco-white"
      >
        <div className="max-w-6xl mx-auto">
          ...
          >
            Why Choose ecoNutrient?
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div
              data-aos="fade-up"
              data-aos-delay="400"
              className="text-center p-6 rounded-lg bg-gradient-to-br from-eco-white/10 to-eco-green-light border border-eco-white/20"
            >
       ...
       <section
         id="shop"
         data-aos="fade-right"
         className="py-20 px-8 bg-eco-white text-eco-green-light"
       >
         <div className="max-w-6xl mx-auto">
           <h2
             data-aos="fade-up"
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Join thousands of Indians who have discovered the power of natural Sattu nutrition.
          </p>
          <div
            data-aos="zoom-in"
            data-aos-delay="600"
